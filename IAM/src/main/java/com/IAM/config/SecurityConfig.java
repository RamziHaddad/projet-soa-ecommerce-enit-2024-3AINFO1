    ...
    protected DefaultSecurityFilterChain configure(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/ecommerce/**").hasRole("ECOMMERCE_ADMIN")
                        .requestMatchers("/api/manager/**").hasRole("ECOMMERCE_MANAGER")
                        .requestMatchers("/api/user/**").hasRole("ECOMMERCE_USER")
